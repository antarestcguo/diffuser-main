...
try:
    ...
    from .pipeline_stable_diffusion import StableDiffusionPipeline, StableDiffusionStepPipeline,StableDiffusionPipelineLayout
    from .pipeline_stable_diffusion_attend_and_excite import StableDiffusionAttendAndExcitePipeline
    from .pipeline_stable_diffusion_controlnet import StableDiffusionControlNetPipeline,StableDiffusionImg2ImgControlNetPipeline
    from .pipeline_stable_diffusion_img2img import StableDiffusionImg2ImgPipeline, StableDiffusionImg2ImgStepPipeline,StableDiffusionImg2ImgMergePipeline
