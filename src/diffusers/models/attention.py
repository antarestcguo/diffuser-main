...
from .attention_processor import Attention, AttentionLayout
...
class BasicTransformerBlockLayout(nn.Module):
    r"""
    A basic Transformer block.
    ...
    def __init__(
        ...
        super().__init__()
        # tc add log
        print("init BasicTransformerBlockLayout")
        self.only_cross_attention = only_cross_attention
    ...
    def forward(
        ...
        cross_attention_kwargs = cross_attention_kwargs if cross_attention_kwargs is not None else {}
        attn_output, self_attn_prob = self.attn1(
            norm_hidden_states,
            encoder_hidden_states=encoder_hidden_states if self.only_cross_attention else None,
            attention_mask=attention_mask,
            **cross_attention_kwargs,
        ...
        return hidden_states, cross_attn_prob, self_attn_prob
