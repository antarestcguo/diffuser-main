...
def main(args):
    ...
    textual_inversion_embedding_path = args.textual_inversion_embedding_path
    tokenizer, text_encoder = load_textual_embedding(file_path=textual_inversion_embedding_path, tokenizer=tokenizer,
