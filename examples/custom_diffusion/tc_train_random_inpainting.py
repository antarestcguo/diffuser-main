...
from diffusers.datasets import TCCustomDiffusionRMaskInpaintingDataset, random_mask, prepare_mask_and_masked_image
...
def main(args):
    ...
    train_dataset = TCCustomDiffusionRMaskInpaintingDataset(
