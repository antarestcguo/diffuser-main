...
sys.path.append("../../")
from tc_utils.utils import setup_seed
from tc_utils.layout_utils import Pharse2idx

parser = argparse.ArgumentParser()
parser.add_argument("--model_id", type=str, default='/data1/tc_guo/models/models/stable-diffusion-2')
parser.add_argument("--save_path", type=str)
parser.add_argument("--seed", type=int, default=1024)
parser.add_argument("--bz", type=int, default=5)
...
for i in range(inference_time):
    ...
    for idx, it_img in enumerate(image):
        it_img.save(
            os.path.join(save_path, "%d.jpg" % (idx + i * args.bz)))
